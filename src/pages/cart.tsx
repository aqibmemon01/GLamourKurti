    ...
    <div className="cart-container">
      <div className="cart-details"
       style={{marginTop: '100px'}}>
        {[1].length > 0 ? 
        [1].map(cart => (<div className="cart" key={"cart.id"}>
          ...
          <span className="inc" 
        //   onClick={() => dispatch({type: 'INCREAMENT', id: cart.id, cart})}
          >
            <i className="fas fa-plus"></i></span>
          <span className="product-quantity">{"cart.qty"}</span>
          <span className="dec" 
        //   onClick={() => dispatch({type: 'DECREAMENT', id: cart.id, cart})}
          >
     ...
     {[1].length > 0 ? <div className="cart-summary">
